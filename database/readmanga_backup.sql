...
INSERT INTO `manga` (`id_manga`, `id_theloaimanga`, `id_taikhoan`, `manga_name`, `slug`, `mota`, `tacgia`, `anh`, `status`, `create_day`) VALUES
	(1, 1, 2, 'Naruto', 'naruto', 'Câu chuyện về ninja Naruto Uzumaki với ước mơ trở thành Hokage.', 'Masashi Kishimoto', 'https://picsum.photos/seed/naruto/200/280', 1, '2026-04-06 14:25:52.3540'),
	(2, 2, 2, 'One Piece', 'one-piece', 'Hành trình của Luffy tìm kho báu One Piece.', 'Eiichiro Oda', 'https://picsum.photos/seed/onepiece/200/280', 1, '2026-04-06 14:25:52.3540'),
	(3, 1, 2, 'Demon Slayer', 'demon-slayer', 'Tanjiro chiến đấu với ác quỷ để cứu em gái.', 'Koyoharu Gotouge', 'https://picsum.photos/seed/demonslayer/200/280', 1, '2026-04-06 14:25:52.3540'),
	(4, 3, 2, 'Doraemon', 'doraemon', 'Chú mèo máy đến từ tương lai giúp đỡ Nobita.', 'Fujiko F. Fujio', 'https://picsum.photos/seed/doraemon/200/280', 1, '2026-04-06 14:25:52.3540');
